<?php  
      ...
      $id = $_GET['update_id'];
          $query="SELECT * FROM tb_pustakawan WHERE nama = :id";
      ...
      if(isset($_POST['btn_update'])){
         ...
         try {
            ...
            if(!isset($errorMsg)){
                  if(empty($nama)||empty($email)||empty($telp)){
                        ...
                        $query="UPDATE tb_pustakawan SET nama=:nama, phone=:phone, email=:email WHERE id_penerbit=:id";
                        ...
                        header("Location:../../pages/managepustakawan.php?info=berhasiltambah");
      ...
      <div align="center">
            <form method="post" enctype="multipart/form-data" action="">
                        <table align="center" class="table">
                              <tr>
                                    <td class="label" width="20%">ID Penerbit</td>
                              ...
                              <tr>
                                    <td></td>
                                    <td><input class="submitbtn" type="submit" name="btn_update" value="Update"></td>
                              </tr>
                        </table>
            </form>
      </div>
